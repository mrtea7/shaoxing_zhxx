...
var data_musics = [];
data_musics.push({
    id: 7926593, name: "Song From A Secret Garden", singer: "Secret Garden",
...
data_sup_todo_list.push({id: 12321, title: "2016年4月份计划表", deadline: "2016-03-25", status: "已完成"});
data_sup_todo_list.push({id: 3221, title: "2016年2月份计划表", deadline: "2016-03-15", status: "已超期"});
data_sup_todo_list.push({id: 1111, title: "2016年1月份计划表", deadline: "2016-03-22", status: "已超期"});
data_sup_todo_list.push({id: 9889, title: "2016年4月份计划表", deadline: "2016-03-05", status: "已完成"});