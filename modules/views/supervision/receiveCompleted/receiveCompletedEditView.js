...
var unfinishedEditView = BaseView.extend(module, {
    ...
    doInit: function () {
        ...
        var callbacks = [this.getOrderInfo, this.getOrderType, this.getCompany];//前一个方法的callback就是后一个方法的参数
    ...
    getOffice: function (params, callback) {
        var self = this;
        Utils.each(params,function (data) {
            DeptService.officeList(params.session, data.bean.id, function (err, ret) {
